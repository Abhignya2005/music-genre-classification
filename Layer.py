...
torch.backends.cudnn.benchmark = False  # Avoids optimizations that may lead to non-determinism
...
sss = StratifiedShuffleSplit(n_splits=1, test_size=0.3, random_state=42)  # Fixed random_state for reproducibility of the split
